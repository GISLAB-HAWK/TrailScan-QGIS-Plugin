...
class TrailscanInferenceProcessingAlgorithm(QgsProcessingAlgorithm):
    ...
    def read_img(self, input_file, dim_ordering="HWC", dtype='float32', band_mapping=None, return_extent=False):
    ...
    def array_to_tif(self, array, dst_filename, num_bands='multi', save_background=True, src_raster: str = "", transform=None,
                    crs=None):
    ...
    def processAlgorithm(
        ...
        try:
            ...
            # Load input file
            img = self.read_img(file_path, dim_ordering="CHW")[[0, 1, 2, 3]]
